                                ...
                                <div className="flex items-center justify-between">
                                    <CardTitle className="text-base font-semibold text-gray-800 flex items-center gap-2">
                                        ...
                                        {newPreviews.length > 0 && (
                                            <Badge variant="secondary" className="ml-1 text-xs">{newPreviews.length} new</Badge>
                                        )}
                                    </CardTitle>
                                    <Button
                                        type="button"
                            ...
                            <CardContent className="px-6 py-6">
                                {newPreviews.length === 0 ? (
                                    ...
                                    >
                                        ...
                                        <span className="text-sm text-gray-400">Click to add more images</span>
                                        <span className="text-xs text-gray-300">JPG, PNG, WebP · Max 2MB each</span>
                                    </button>
                                ) : (
                                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                                        <AnimatePresence>
                                            {newPreviews.map((preview) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="absolute top-1.5 left-1.5">
                                                        <Badge className="bg-blue-600 text-white border-0 text-xs px-1.5 py-0.5">New</Badge>
                                                    </div>
                                                    <button
                                                        type="button"
                    ...
                    <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.2 }}>
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-gray-500">
                                This image will be permanently deleted from the gallery. This action cannot be undone.
                            </DialogDescription>
                        </DialogHeader>
                        <DialogFooter className="mt-4 gap-2">
                            <Button variant="outline" onClick={() => setDeleteImageId(null)} className="border-gray-200">
                                Cancel
                            </Button>
