...
import { Upload, User, ImageIcon, CheckCircle2, Loader2 } from 'lucide-react';
...
interface PageProps {
    headmaster: HeadmasterData | null;
...
export default function HeadmasterIndex() {
    const { headmaster, flash } = usePage<PageProps>().props;

    const [title, setTitle] = useState<string>(headmaster?.title ?? '');
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-0.5">
                                Manage the headmaster section of your school profile
                            </p>
                        </div>
                    </div>
                            ...
                            <Card className="rounded-2xl shadow-sm border-gray-200">
                                ...
                                <CardContent className="space-y-5">
                                    <div className="space-y-1.5">
                                        ...
                                        <Input
                                            id="title"
                                            placeholder="e.g. About Our Headmaster"
                                            value={title}
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <Textarea
                                            id="content"
                                            placeholder="Write about the headmaster..."
                                            value={content}
