        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-2 sm:p-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-xl sm:text-2xl font-semibold text-slate-900 dark:text-white">Create Banner</h1>
                        <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400">Add a new banner to the homepage</p>
                    </div>
                </div>
