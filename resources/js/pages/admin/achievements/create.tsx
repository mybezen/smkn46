            ...
            <motion.div className="space-y-6 p-6" variants={fadeIn} initial="hidden" animate="visible">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-gray-500">Add a new achievement</p>
                    </div>
                </div>
                                ...
                                <CardContent className="px-6 py-6 space-y-5">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div
                                            ...
                                            className={`cursor-pointer rounded-lg border-2 border-dashed p-6 transition-all hover:border-blue-400 hover:bg-blue-50/50 ${errors.thumbnail ? 'border-red-400' : 'border-gray-200'
                                                }`}
                                        >
                                            {preview ? (
                                                <motion.div
